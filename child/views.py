...
def registered(request):
    ...
    try:
        user = request.POST.get('sno')
        pwd = request.POST.get('password')
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1=cursor.callfunc('sign_card',mysql.STRING,[user,pwd])
        cursor.close()
        conn.commit()
        conn.close()
...
def pay(request):
    ...
    try:
        ...
        # conn = mysql.connect('system/Abc12345@localhost:1521/orcl')
        # cursor = conn.cursor()
        # result1=cursor.callfunc('cost_sign',cx_Oracle.NUMBER,[sno,passwd,moeny])

        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1 = cursor.callfunc('cost_sign', mysql.NUMBER, [sno, passwd, moeny])
...
def recharge(request):
    ...
    try:
        ...
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1=cursor.callfunc('fill_sign',mysql.NUMBER,[sno,moeny])
...
def getExpenditureInfo(request):
    ...
    try:
        ...
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1=cursor.callfunc('G_Cardno',mysql.STRING,[sno])
...
def changePassword(request):
    ...
    try:
        ...
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1 = cursor.callfunc('Cp_sign',mysql.STRING,[sno,password])
        response['error_code'] = 0
        cursor.close()
        conn.commit()
        conn.close()
...
def RPW(request):
    ...
    try:
        ...
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1 = cursor.callfunc('Fg_sign',mysql.STRING,[sno,cno,password])
        cursor.close()
        conn.commit()
        conn.close()
...
def reportLoss(request):
    ...
    try:
        ...
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1 = cursor.callfunc('Los_sign',mysql.NUMBER,[sno])
        cursor.close()
        conn.commit()
        conn.close()
        response['sno'] = sno
...
def cancelReportLoss(request):
    ...
    try:
        ...
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1 = cursor.callfunc('Dele_los',mysql.NUMBER,[sno])
        cursor.close()
        conn.commit()
        conn.close()
...
def getReportLoss(request):
    ...
    try:
        ...
        conn = mysql.connect('root/@localhost:1521/monamii')
        cursor = conn.cursor()
        result1 = cursor.callfunc('Get_los',mysql.NUMBER,[sno])
        cursor.close()
        conn.commit()
        conn.close()
